...
class Settings(BaseSettings):
    ...
    LEGEND_LAYOUT_MIN_INSIDE_RATIO: float = 0.4
    LEGEND_ROWS_SIMILARITY_THRESHOLD: float = 0.9
    LEGEND_DESCRIPTION_HORIZONTAL_MODIFIER: float = 0.1

    HATCHING_LEGEND_FALLBACK_MIN_WALL_COUNT: int = 100
    HATCHING_LEGEND_FALLBACK_MIN_AVERAGE_CONFIDENCE: float = 0.15
